...
def main() -> int:
    ...
    expect("W-src-version-035", module.SKILL_VERSION == "0.36", module.SKILL_VERSION)
    ...
    expect(
        ...
        "batch-02.json" in templates and "/multi-window-m-036" in templates,
        templates[:200],
    )
    ...
    expect("W-doc-name-is-kebab", declared == "multi-window-m-036", declared)
